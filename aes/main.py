...
from aes import encrypt_gui, decrypt_gui
...
class AESCipherApp:
    ...
    def btn_encrypt(self):
        ...
        encrypt_text = encrypt_gui(input_text, key_text)
        self.output_text.insert(tk.END, encrypt_text)
    ...
    def btn_decrypt(self):
        ...
        if not input_text or not key_text:
            ...
            return
        self.output_text.delete("1.0", tk.END)
        decrypt_text = decrypt_gui(input_text, key_text)
        self.output_text.insert(tk.END, decrypt_text)
